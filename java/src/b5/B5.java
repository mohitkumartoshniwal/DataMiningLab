...
{
	BufferedReader csv = new BufferedReader(new FileReader(new File("/Users/mohit/eclipse-workspace/DMLab/src/b5/input.csv")));
	...
	while(data != null)
{
	...
	//initial probability
	int total = y.size() + n.size();
	double p_y = (double)y.size()/(double)total;
	double p_n = (double)n.size()/(double)total;
